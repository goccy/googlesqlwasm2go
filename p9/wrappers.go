...
func callIndirect_type0(m *base.Module, idx int32, p0 int32, p1 int32) int64 {
...
func callIndirect_type17(m *base.Module, idx int32, p0 int32, p1 int32, p2 int32, p3 int32, p4 int32, p5 int32) int32 {
	return m.T0[idx].(func(*base.Module, int32, int32, int32, int32, int32, int32) int32)(m, p0, p1, p2, p3, p4, p5)
}

func callIndirect_type19(m *base.Module, idx int32, p0 int32, p1 int32, p2 int32, p3 int32, p4 int32, p5 int32, p6 int32, p7 int32) {
	m.T0[idx].(func(*base.Module, int32, int32, int32, int32, int32, int32, int32, int32))(m, p0, p1, p2, p3, p4, p5, p6, p7)
}

func callIndirect_type20(m *base.Module, idx int32, p0 int32, p1 int64) {
	m.T0[idx].(func(*base.Module, int32, int64))(m, p0, p1)
}

func callIndirect_type22(m *base.Module, idx int32) {
	m.T0[idx].(func(*base.Module))(m)
}

func callIndirect_type24(m *base.Module, idx int32, p0 int32, p1 int32, p2 int32, p3 int32, p4 int32, p5 int32, p6 int32, p7 int32, p8 int32) {
...
func callIndirect_type50(m *base.Module, idx int32, p0 int32, p1 int32) float64 {
	return m.T0[idx].(func(*base.Module, int32, int32) float64)(m, p0, p1)
}

func callIndirect_type58(m *base.Module, idx int32, p0 int32, p1 int32) float32 {
	return m.T0[idx].(func(*base.Module, int32, int32) float32)(m, p0, p1)
}
