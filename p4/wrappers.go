...
func callIndirect_type27(m *base.Module, idx int32, p0 int32, p1 int32, p2 int64) {
	m.T0[idx].(func(*base.Module, int32, int32, int64))(m, p0, p1, p2)
}

func callIndirect_type96(m *base.Module, idx int32, p0 int64) {
	m.T0[idx].(func(*base.Module, int64))(m, p0)
}
