...
func callIndirect_type30(m *base.Module, idx int32, p0 int32, p1 int64, p2 int32) {
	m.T0[idx].(func(*base.Module, int32, int64, int32))(m, p0, p1, p2)
}

func callIndirect_type68(m *base.Module, idx int32, p0 int32, p1 float64, p2 int32) {
	m.T0[idx].(func(*base.Module, int32, float64, int32))(m, p0, p1, p2)
}

func callIndirect_type91(m *base.Module, idx int32, p0 int32, p1 float32, p2 int32) {
	m.T0[idx].(func(*base.Module, int32, float32, int32))(m, p0, p1, p2)
}
