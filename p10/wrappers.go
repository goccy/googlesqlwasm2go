...
func callIndirect_type48(m *base.Module, idx int32, p0 int32, p1 int32, p2 int64, p3 int32, p4 int32) {
	m.T0[idx].(func(*base.Module, int32, int32, int64, int32, int32))(m, p0, p1, p2, p3, p4)
}
